...
setData({...data,[id]:value})
 ...
 <div className='left'>
     ...
     <form id="szfield" onSubmit={onSubmit}>
     ...
     <input id="email" type="email" placeholder="Enter Email" onChange={onChange} required/>
    <br/>
       <label> 
   ...
   <div className='element'> 
    ...
    <label>I’m over 13 years of age and agree to <br/> Gaana     <a href="#" class="para"> Terms and Conditions </a></label>
    </div>
